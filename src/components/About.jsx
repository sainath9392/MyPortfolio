      ...
      <div className="relative h-full w-full overflow-hidden">
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 ">
          <a
            ...
            className="text-[#6b645c] hover:text-white bg-[#d1d1c7] hover:bg-[#6b645c] focus:ring-4 focus:ring-[#c0ae9a] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center"
          >
            Scroll Down
          </a>
        </div>
